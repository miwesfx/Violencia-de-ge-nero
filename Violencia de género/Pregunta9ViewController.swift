...
class Pregunta9ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        var DestViewController : Pregunta10ViewController = segue.destinationViewController as! Pregunta10ViewController
