...
class Pregunta6ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        var DestViewController : Pregunta7ViewController = segue.destinationViewController as! Pregunta7ViewController
