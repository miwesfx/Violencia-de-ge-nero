...
class Pregunta8ViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        var DestViewController : Pregunta9ViewController = segue.destinationViewController as! Pregunta9ViewController
